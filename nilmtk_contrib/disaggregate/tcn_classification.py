...
class identity_block(Layer):
    def __init__(self, filter,kernel_size):
        ...
        self.conv1=TCN(filter[0], kernel_size=kernel_size, dilations=[1,2,4,8], return_sequences=True, activation = 'relu')
        self.conv2=TCN(filter[1], kernel_size=kernel_size, dilations=[1,2,4,8], return_sequences=True, activation = 'relu')
        self.conv3=TCN(filter[2], kernel_size=kernel_size, dilations=[1,2,4,8], return_sequences=True, activation = 'relu')
...
class convolution_block(Layer):
    def __init__(self, filter,kernel_size):
        ...
        self.conv2=TCN(filter[1], kernel_size=kernel_size, dilations=[1,2,4,8], return_sequences=True, activation = 'relu')
        self.conv3=TCN(filter[2], kernel_size=kernel_size, dilations=[1,2,4,8], return_sequences=True, activation = 'relu')
        self.conv4=TCN(filter[2], kernel_size=kernel_size, dilations=[1,2,4,8], return_sequences=True, activation = 'relu')
...
class TCN_classification(Disaggregator):

    def __init__(self, params):

        self.MODEL_NAME = "TCN_classification"
    ...
    def partial_fit(self,train_main,train_appliances,do_preprocessing=True,**load_kwargs):
        ...
        print("...............TCN_classification partial_fit running...............")
        ...
        for appliance_name, power in train_appliances:
            ...
            if train_main.size > 0:
                ...
                if len(train_main) > 10:
                    ...
                    filepath = 'TCN_classification-temp-weights-'+str(random.randint(0,100000))+'.h5'
